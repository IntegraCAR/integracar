    ...
    useEffect(() => {
        ...
        async function load() {
            ...
            try {
                ...
                const res = await fetch(`${base}/bolsista`, { credentials: "include", headers: { Accept: 'application/json' } })
                if (res.status === 401) {
                    try {
                                        ...
                                        <tr key={idx} className="hover:bg-gray-50">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right">
                                                <Button
                                                    ...
                                                    onClick={() => router.push(`/bolsista/processo?cod=${processo.cod_processo}`)}
                                                >
                                                    → Ver Processo
                                                </Button>
                                            </td>
